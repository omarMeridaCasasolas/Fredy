    ...
    <section>
        ...
        onkeyup="liveComment_titulo(this.value)" />
            ...
            <div class="btn-der">
                ...
                <!---                        --------------------------------- -------------------->
                <input href="" type="submit" onclick='alerta()' name="" value="Siguiente" class="btn btn-info"/>
                            ...
                            <div class="modal-body">
                                <div id="previsualizacion" class="flotando">
                                    <fieldset>
                                        ...
                                        <p class="titulo"> <span id="preview_name" class="negrita"> </span> (<span id="preview_email"></span>)</p>
